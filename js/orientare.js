document.getElementById("id_business_version").innerHTML = "Bussiness version: 2018.11.02 - 06";
...
function on_device_motion(e){
	...
	document.getElementById("id_acc_z").innerHTML = e.accelerationIncludingGravity.z;
		...
		document.getElementById("id_rot_x").innerHTML = Math.atan(e.accelerationIncludingGravity.x / e.accelerationIncludingGravity.z);
		document.getElementById("id_rot_y").innerHTML = Math.atan(e.accelerationIncludingGravity.y / e.accelerationIncludingGravity.z);
